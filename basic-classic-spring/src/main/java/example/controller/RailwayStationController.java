...
import example.service.RailwayStationServiceImpl;
...
public class RailwayStationController {
	...
	public @ResponseBody void addRailwayStation(
			@RequestBody RailwayStation railwayStation) {
		railwayStationsService.addRailwayStation(railwayStation);
	}

	@RequestMapping(value = "/update", method = RequestMethod.PUT)
	public @ResponseBody void updateRailwayStation(
			@RequestBody RailwayStation railwayStation) {
