...
public class PercentileTest {
    static final private RrdBackendFactory backend = new RrdMemoryBackendFactory();
    ...
    public static void setBackendBefore() {
        ...
        RrdBackendFactory.setActiveFactories(backend);
    }
    ...
    public void createRrdFile(String fileName, long startTime) throws Exception {
        RrdDef def = new RrdDef(backend.getUri(fileName), 300);
