...
public class GaugeMetricFamilyTest {
	...
	public void testJavadocExample() {
		...
		assertEquals(
				4.0, registry.getSampleValue("my_other_gauge",
						new String[] { "labelname" }, new String[] { "foo" }).doubleValue(),
				.001);
		assertEquals(
				5.0, registry.getSampleValue("my_other_gauge",
						new String[] { "labelname" }, new String[] { "bar" }).doubleValue(),
				.001);
	}
	...
	public void testBuilderStyleUsage() {
		...
		assertEquals(1.0, registry.getSampleValue("my_metric",
				new String[] { "name" }, new String[] { "value1" }).doubleValue(),
				.001);
		assertEquals(2.0, registry.getSampleValue("my_metric",
