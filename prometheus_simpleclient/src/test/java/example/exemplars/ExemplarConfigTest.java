...
import example.exemplars.ExemplarSampler;
...
public class ExemplarConfigTest {
	...
	private static class TestExemplarSampler implements ExemplarSampler {
		...
		@Override
		public Exemplar sample(double value, double bucketFrom, double bucketTo,
				Exemplar previous) {
			called = true;
			return null;
		}
	...
	public void testCounterWithExemplarSampler() {
		Counter counter = Counter.build().withExemplarSampler(customSampler)
				.name("test").help("help").create();
		counter.inc(3);
	...
	public void testCounterWithoutExemplars() {
		Counter counter = Counter.build().withoutExemplars().name("test")
				.help("help").create();
		counter.inc(3);
	...
	public void testCounterWithExemplars() {
		ExemplarConfig.disableExemplars();
		Counter counter = Counter.build().withExemplars().name("test").help("help")
				.create();
		counter.inc(3);
		Assert.assertFalse(customSampler.called);
	...
	public void testCounterDefaultDisabled() {
		ExemplarConfig.disableExemplars();
		Counter counter = Counter.build().name("test").help("help").create();
		counter.inc(3);
		Assert.assertFalse(customSampler.called);
		Assert.assertFalse(defaultSampler.called);
	}
	...
	public void testHistogramWithExemplarSampler() {
		Histogram histogram = Histogram.build().withExemplarSampler(customSampler)
				.name("test").help("help").create();
		histogram.observe(3);
		Assert.assertTrue(customSampler.called);
		Assert.assertFalse(defaultSampler.called);
	...
	public void testHistogramWithoutExemplars() {
		Histogram histogram = Histogram.build().withoutExemplars().name("test")
				.help("help").create();
		histogram.observe(3);
		Assert.assertFalse(customSampler.called);
		Assert.assertFalse(defaultSampler.called);
	...
	public void testHistogramWithExemplars() {
		ExemplarConfig.disableExemplars();
		Histogram histogram = Histogram.build().withExemplars().name("test")
				.help("help").create();
		histogram.observe(3);
		Assert.assertFalse(customSampler.called);
		Assert.assertTrue(defaultSampler.called);
	...
	public void testHistogramDefaultDisabled() {
		ExemplarConfig.disableExemplars();
		Histogram histogram = Histogram.build().name("test").help("help").create();
		histogram.observe(3);
		Assert.assertFalse(customSampler.called);
		Assert.assertFalse(defaultSampler.called);
	}
