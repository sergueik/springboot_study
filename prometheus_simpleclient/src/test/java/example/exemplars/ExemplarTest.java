...
public class ExemplarTest {
	...
	public void testCompleteExemplar() {
		...
		String traceId = "abc";
		String spanId = "def";
		Exemplar exemplar = new Exemplar(value, timestamp, SPAN_ID, spanId,
				TRACE_ID, traceId);
	...
	public void testMaxLabelLength() {
		...
		new Exemplar(42, ten, twenty, thirty, forty, eight, twenty); // 128 chars
																																	// total
		try {
			new Exemplar(42, ten, twenty, thirty, forty, eight, twenty + "1"); // 129
																																					// chars
																																					// total
		} catch (IllegalArgumentException e) {
			return;
	...
	public void testNotUniqueLabelNames() {
		try {
			new Exemplar(42, "label1", "value1", "label2", "value2", "label1",
					"value1");
		} catch (IllegalArgumentException e) {
			return;
		}
	...
	public void testNotUniqueLabelValues() {
		...
		new Exemplar(42, "label1", "value1", "label2", "value1", "label3",
				"value1");
	}
