		...
		class YourCustomCollector extends Collector {
			public List<MetricFamilySamples> collect() {
				...
				return Arrays.<MetricFamilySamples> asList(
						new MetricFamilySamples("a_total", Type.COUNTER, "help",
								Arrays.asList(new MetricFamilySamples.Sample("a_total",
										emptyList, emptyList, 1.0))),
						new MetricFamilySamples("b", Type.COUNTER, "help",
								Arrays.asList(new MetricFamilySamples.Sample("b", emptyList,
										emptyList, 2.0))),
						new MetricFamilySamples("c_total", Type.COUNTER, "help",
								Arrays.asList(new MetricFamilySamples.Sample("c", emptyList,
										emptyList, 3.0))),
						new MetricFamilySamples("d", Type.COUNTER, "help",
								Arrays.asList(new MetricFamilySamples.Sample("d_total",
										emptyList, emptyList, 4.0))));
			}
		}
