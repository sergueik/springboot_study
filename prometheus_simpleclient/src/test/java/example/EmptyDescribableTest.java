...
public class EmptyDescribableTest {
	...
	static class TestCollector extends Collector
		...
		public List<MetricFamilySamples> collect() {
			...
			List<MetricFamilySamples.Sample> samples = new ArrayList<MetricFamilySamples.Sample>(
					2);
			samples.add(new MetricFamilySamples.Sample("my_metric", labelNames,
					labelValues1, 1.0));
			samples.add(new MetricFamilySamples.Sample("my_metric", labelNames,
					labelValues2, 2.0));
			MetricFamilySamples mfs = new MetricFamilySamples("my_metric", "",
					Type.UNKNOWN, "help text", samples);
	...
	public void testEmptyDescribe() {
		...
		Set<String> includedNames = new HashSet<String>(
				Collections.singletonList("my_metric"));
		List<Collector.MetricFamilySamples> mfs = Collections
