...
public class Utils {
	...
	public String getValue(final String configurationKey) {
		...
		try {
			...
			for (; e.hasMoreElements();) {
				...
				// System.err.println(String.format("Added: \"%s\" = \"%s\"", key,
				// val));
				propertiesMap.put(key, val);
			}
		} catch (IOException e) {
			System.err.println(
					"Properties file was not found or not readable: " + e.toString());
		}

		return propertiesMap.get(configurationKey);
	}
