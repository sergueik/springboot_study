...
public class ItemUpdateResource {
	 ...
	 */
	@java.lang.SuppressWarnings("all")
	public ItemUpdateResource setDescription(final String description) {
	 ...
	 */
	@java.lang.SuppressWarnings("all")
	public ItemUpdateResource setStatus(final ItemStatus status) {
		this.status = status;
		return this;
	}
	 ...
	 */
	@java.lang.SuppressWarnings("all")
	public ItemUpdateResource setAssigneeId(final Long assigneeId) {
	 ...
	 */
	@java.lang.SuppressWarnings("all")
	public ItemUpdateResource setTagIds(final Set<Long> tagIds) {
		this.tagIds = tagIds;
		return this;
	}
	...
	public boolean equals(final java.lang.Object o) {
		if (o == this)
			return true;
		if (!(o instanceof ItemUpdateResource))
			return false;
		final ItemUpdateResource other = (ItemUpdateResource) o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof ItemUpdateResource;
	}
	...
	public java.lang.String toString() {
		return "ItemUpdateResource(description=" + this.getDescription()
