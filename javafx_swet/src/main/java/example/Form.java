...
public class Form extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        HBox box = new HBox(50, button, button2);
        box.setAlignment(Pos.CENTER);
        primaryStage.setScene(new Scene(box, 600, 400));
        primaryStage.show();
 
        button.setOnAction(event -> new ToolWin("Антивирусные базы обновлены").show());
        button2.setOnAction(event -> new modAlert(Alert.AlertType.INFORMATION, "Антивирусные базы обновлены").Show());
    }
    ...
    class ToolWin extends Application {
        ...
        public void init() throws Exception {
            super.init();
            root = new Group(new StackPane(new Rectangle(WIDTH, HEIGHT, new Color(0.6784314f, 0.84705883f, 0.9019608f, .9)), new Label(contentText)));
