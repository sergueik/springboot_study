...
# origin: https://github.com/cytopia/ansible-modules/blob/master/modules/diff.py
...
# Module alias error: internal error: required and default are mutually exclusive for
            source_type=dict(required=False, default='string',
                             choices=['string', 'file', 'command']),
            target_type=dict(required=False, default='string',
                             choices=['string', 'file', 'command']),
        ),
