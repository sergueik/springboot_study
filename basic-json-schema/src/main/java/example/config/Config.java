...
public class Config implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry.addResourceHandler("/components/**").addResourceLocations("classpath:/components", String.format(
				"file:///%s/src/main/resources/components/", System.getProperty("user.dir").replaceAll("\\\\", "/")));
