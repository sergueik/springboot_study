...
public class TutorialController {
	...
	@GetMapping(value = "/sortedtutorials")
	...
	public ResponseEntity<Map<String, Object>> findByPublished(
		...
		try {
			...
			Page<Tutorial> pageTuts = tutorialRepository.findByPublished(true,
					paging);
			tutorials = pageTuts.getContent();
	...
	@PutMapping(value = "/tutorials/{id}", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
