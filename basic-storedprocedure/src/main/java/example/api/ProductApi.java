...
public class ProductApi {
	...
	public String callProcedure(@RequestBody Product product) {
		Object[] params = new Object[] { UUID.randomUUID().toString(),
				product.getCode(), product.getName(), product.getWeight() };
	...
	public Long callFunctionCountProduct() {
		Long count = (Long) utils.callStoredFunction(Types.BIGINT,
				"count_product()", null);
		return count;
	}
	...
	public Long callFunctionCountProductJdbc() {
		Long count = (Long) jdbcUtils.callStoredFunction("count_product", null,
				Long.class);
		return count;
	}
}
