package example.data.viewmodel;
...
public class EventSubscriptionViewModel {
	...
	public static EventSubscriptionViewModel fromEventSubscription(
		...
		viewModel.setUserAccount(UserAccountViewModel
				.fromUserAccount(eventSubscription.getUserAccount()));
