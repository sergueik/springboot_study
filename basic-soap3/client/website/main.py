...
client = zeep.Client(wsdl =  'http://{}:8888/CurrencyConversionWebServiceAA1922?wsdl'.format(server)  )
...
def currencyConvert():
    ...
    # build and return the XML before sending it to the server
    # node = client.create_message(client.service, 'convert', 'amountInSourceCurrency' = value1, 'sourceCurrency' = currency1, 'targetCurrency' = currency2)
    # SyntaxError: keyword can't be an express
    # TypeError: {http://aa1922.sltc.com/}convert() got an unexpected keyword argument 'amountInSourceCurrency'. Signature: `arg0: xsd:double, arg1: xsd:string, arg2: xsd:string`
