...
public class Utils {
	...
	private final static String lineProtocolGrammar = "([-a-z0-9_]+)((?:,[-a-z0-9_=\"]+)*) (?:([-a-z0-9_]+=[-a-z0-9_\"]+)(?:,[-a-z0-9_]+=[-a-z0-9_\"]+)*) ([0-9]+)$";
	private final static String tagGrammar = "([-a-z0-9_]+)=([-a-zA-Z0-9_]+)(?:,([-a-zA-Z0-9_=\"]+)*)";
	private final static String fieldGrammar = "([-a-z0-9_]+)=([-a-zA-Z0-9_]+)(?: ([-a-zA-Z0-9_=\"]+)*)";
