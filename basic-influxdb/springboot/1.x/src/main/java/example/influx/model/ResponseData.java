...
public class ResponseData {
	...
	public ResponseData(Boolean success, Integer code, String message,
			String localizedMsg, Object data) {
		this.success = success;
		this.code = code;
		this.message = message;
	...
	public static SuccessResponseData success(Integer code, String message,
			String localizedMsg, Object object) {
	...
	public int hashCode() {
		...
		result = result * 59
				+ ($localizedMsg == null ? 43 : $localizedMsg.hashCode());
	...
	public String toString() {
		return "ResponseData(success=" + this.getSuccess() + ", code="
				+ this.getCode() + ", message=" + this.getMessage() + ", localizedMsg="
				+ this.getLocalizedMsg() + ", data=" + this.getData() + ")";
	}
}
