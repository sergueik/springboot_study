...
import net.sf.cobolToJson.def.IJsonObjectToCobolRecordOut;

public class JsonObjectToCobolRecord implements IJsonObjectToCobolRecordOut, IJsonObjectToCobolRecordIn {
	private final Cobol2JsonImp cbl2json;
	
	private Reader readerJsonFile;
	
	
	public JsonObjectToCobolRecord(Cobol2JsonImp cbl2json) {
		super();
	 ...
	 */
	@Override
	public JsonObjectToCobolRecord setJsonString(String jsonString) {
	 ...
	 */
	@Override
	public JsonObjectToCobolRecord setJsonInput(String filename) throws FileNotFoundException {
	 ...
	 */
	@Override
	public JsonObjectToCobolRecord setJsonInput(Reader reader) {
	...
	public void writeCobolDataFile(OutputStream cobolDataStream) throws IOException {
		checkReaderExists();
		cbl2json.jsonObjectToCobolFile(readerJsonFile, cobolDataStream);
	}
	 ...
	 */
	@Override
	public AbstractLine toCobolDataLine() throws IOException {
		checkReaderExists();
		return cbl2json.jsonObjectToCobolLine(readerJsonFile);
	}
}
