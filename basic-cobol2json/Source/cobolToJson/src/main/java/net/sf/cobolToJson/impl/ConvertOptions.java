...
public class ConvertOptions {
	...
	private static final String OPT_PRETTY   = "-pretty";
	...
	public final boolean dropCopybookName, useCobol, pretty;
	...
	public ConvertOptions(String[] args) {
		...
		dropCopybookName = drop.startsWith("t") || drop.startsWith("y") || "".equals(drop);
		
		String prettyStr = pArgs.getArg(OPT_PRETTY, "").toLowerCase();
		pretty = prettyStr.length() == 0 || prettyStr .startsWith("t") || prettyStr.startsWith("y");
	...
	private void printOptions() {
		...
		System.out.println("          " + OPT_PRETTY   + "  \t- Wether to pretty print the JSON");
		System.out.println();
