...
public class Cobol2Json  {
	 ...
	 * @return Cobol2Json builder
	 */
	public static ICobol2Json newCobol2Json(ICobolCopybookTextSource cobolCopybookDtls) {
		ICobol2Json cobol2Json = Cobol2JsonImp.newCobol2Json(
				cobolCopybookDtls.getFreeFormatCopybookReader(), 
				cobolCopybookDtls.getCopybookName());
		cobol2Json.setCopybookFileFormat(Cb2xmlConstants.FREE_FORMAT);
		return cobol2Json;
	}
