...
//	public static final String MAIN_XML_TAG = "CobolData";
	 ...
	 */
	@Override 
	public abstract ICobol2Json setFormatField(String fieldName, IFormatField formatField);

	/**
	 *  {@inheritDoc}
	 */
	@Override 
	public abstract ICobol2Json setWriteCheck(String groupName, IWriteCheck writeCheck);
	
	/**
	 *  {@inheritDoc}
	 */
	@Override 
	public ICobol2Json setRedefineSelection(String groupName, IRedefineSelection redefineSelection);

	/**
	 * {@inheritDoc}
	 */
	@Override 
	public abstract ICobol2Json setArrayCheck(List<String> groupNames, IArrayItemCheck check);
	
	/**
	 * {@inheritDoc}
	 */
	@Override 
	public abstract ICobol2Json setFormatField(List<String> groupNames, IFormatField formatField);

	/**
	 *  {@inheritDoc}
	 */
	@Override 
	public abstract ICobol2Json setWriteCheck(List<String> groupNames, IWriteCheck writeCheck);
	
	/**
	 *  {@inheritDoc}
	 */
	@Override 
	public ICobol2Json setRedefineSelection(List<String> groupNames, IRedefineSelection redefineSelection);
