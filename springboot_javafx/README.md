...
This directory contains a basic springboot javaFx project replica of
[ruslanys/sample-spring-boot-javafx](https://github.com/ruslanys/sample-spring-boot-javafx)
