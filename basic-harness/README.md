...
```
> NOTE: Containers may transition from unhealthy to starting due to restart
policies. Such containers are reported as warnings under --inspect,
as they indicate recent instability even if currently recovering. For example:
...
Warning: restarting after unhealthy:
/basic-harness-ng-manager-1: starting after unhealthy (restartCount=2)
```
this detected
```sh
docker-compose ps ng-manager
```
```text
NAME                         COMMAND             SERVICE             STATUS               PORTS
basic-harness-ng-manager-1   "./run.sh"          ng-manager          running (starting)   7090/tcp
```

#### Log Parsing

```sh
docker-compose logs --no-color | grep -i -E '(^|\s)-?ERROR\s|WARN.*dns|WARN.*host|WARN.*connection|Exception|UnknownHostException|cannot resolve host|Failed to resolve|SocketTimeoutException|NXDOMAIN|SERVFAIL|ConnectException|Connection refused|No route to host' | grep -vE -i '(basic-harness-mongo|WriteRedisConnectionException)' | tee a.log
```
```text
basic-harness-pipeline-service-1  | ERROR StatusLogger Log4j2 could not find a logging implementation. Please add log4j-core to the classpath. Using SimpleLogger to log to the console...
basic-harness-proxy-1             | 2026/01/06 02:19:30 [error] 30#30: *129 connect() failed (113: No route to host) while connecting to upstream, client: 192.168.0.2, server: , request: "GET /api/ng/accounts/listV2?offset=0&pageSize=2 HTTP/1.1", upstream: "http://192.168.0.13:9090/api/ng/accounts/listV2?offset=0&pageSize=2", host: "proxy"
basic-harness-proxy-1             | 2026/01/06 02:19:33 [error] 30#30: *131 connect() failed (113: No route to host) while connecting to upstream, client: 192.168.0.2, server: , request: "GET /api/ng/accounts/listV2?offset=0&pageSize=2 HTTP/1.1", upstream: "http://192.168.0.13:9090/api/ng/accounts/listV2?offset=0&pageSize=2", host: "proxy"
basic-harness-proxy-1             | 2026/01/06 02:19:36 [error] 30#30: *133 connect() failed (113: No route to host) while connecting to upstream, client: 192.168.0.2, server: , request: "GET /api/ng/accounts/listV2?offset=0&pageSize=2 HTTP/1.1", upstream: "http://192.168.0.13:9090/api/ng/accounts/listV2?offset=0&pageSize=2", host: "proxy"
basic-harness-manager-1           | 2026-01-06 02:06:26,901 [32m[main][0;39m [31mWARN [0;39m [36mdev.morphia.mapping.MappedField[0;39m - Parameterized types are treated as untyped Objects. See field 'properties' on class software.wings.beans.infrastructure.Host [33m[0;39m 
...
basic-harness-delegate-1          | Exception in thread "main" java.lang.OutOfMemoryError: Java heap space
basic-harness-platform-service-1  | 2026-01-06 02:02:53,403 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/pipeline/slack/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,501 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/pipeline/email/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,524 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/pipeline/pagerduty/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,535 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/pipeline/msteams/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,546 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/stage/slack/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,561 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/stage/email/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,572 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/stage/pagerduty/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,586 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/stage/msteams/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,600 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/step/slack/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,612 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/step/email/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,630 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/step/pagerduty/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,657 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/step/msteams/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,686 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/approval/slack/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,694 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/approval/email/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,708 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/approval/slack/plain_text_execution.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,719 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/approval/email/plain_text_execution.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,726 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_simple_project_slack.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,738 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_simple_project_email.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,752 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_simple_project_pagerduty.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,765 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_simple_project_msteams.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,778 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_composite_project_slack.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,792 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_composite_project_email.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,811 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_composite_project_pagerduty.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,824 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_composite_project_msteams.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,834 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_composite_account_slack.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,864 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_composite_account_email.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,873 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_composite_account_pagerduty.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,893 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_slo_composite_account_msteams.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,899 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_monitoredservice_slack.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,912 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_monitoredservice_et_slack.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,946 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_monitoredservice_email.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,965 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_monitoredservice_et_email.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,978 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_monitoredservice_pagerduty.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:53,989 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource cvng_notification_templates/cvng_monitoredservice_msteams.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,219 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/email_test.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,234 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/slack_test.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,243 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/pd_test.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,246 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/msteams_test.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,318 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/pipeline_rejected_email_test.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,326 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/pipeline_rejected_slack_test.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,341 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/pipeline_rejected_pd_test.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,352 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/pipeline_rejected_msteams_test.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,387 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/approval/msteams/plain_text.txt not found. [33m[0;39m 
basic-harness-platform-service-1  | 2026-01-06 02:02:54,437 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.notification.service.SeedDataPopulaterServiceImpl[0;39m - Resource not found, skipping to seed the template - java.lang.IllegalArgumentException: resource notification_templates/approval/msteams/plain_text_execution.txt not found. [33m[0;39m 
basic-harness-manager-1           | 2026-01-06 02:07:14,789 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "stateHostIdx", "background": true} {"workflowId": 1, "stateType": 1, "executionStatus": 1, "workflowStartTs": -1} [33m[indexName=stateHostIdx, collectionName=cvExecutionData][0;39m 
basic-harness-pipeline-service-1  | 2026-01-06 02:14:51,290 [32m[FacilitatorEventRedisConsumer-handler-mMBsiUQgTlOtUmhamcl8tw][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while getting new messages [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:15:00,825 [32m[InitiateNodeEventRedisConsumer-handler-naLy9sa_R-ih7qPqgiq0fQ][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:15:00,836 [32m[GraphUpdateRedisConsumer-handler-Dc7rx2fAS4Cc8P9VmLhDIw][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:15:01,364 [32m[PollingEventStreamConsumer-handler-XTwfyjfcSVOZXWxaWddbFw][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | 2026-01-06 02:15:01,375 [32m[PipelineExecutionSummaryRedisEventConsumer-handler-DIIHvMmkQRqbCbKT258e8g][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:15:01,451 [32m[PmsNotifyEventConsumerRedis-handler--y_c_0RIQUSUJpstHr3DDw][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while getting new messages [33m[0;39m 
basic-harness-ng-manager-1        | 2026-01-06 02:24:22,712 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "unique_instance_deployment_info_idx", "unique": true} {"accountIdentifier": 1, "orgIdentifier": 1, "projectIdentifier": 1, "envIdentifier": 1, "infraIdentifier": 1, "serviceIdentifier": 1, "instanceInfo.host": 1} [33m[indexName=unique_instance_deployment_info_idx, collectionName=instanceDeploymentInfo][0;39m 
basic-harness-pipeline-service-1  | 2026-01-06 02:15:01,510 [32m[git_config_streamGitSyncSdk][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:15:10,472 [32m[FacilitatorEventRedisConsumer-handler-mMBsiUQgTlOtUmhamcl8tw][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | 2026-01-06 02:16:33,727 [32m[PollingEventStreamConsumer-handler-XTwfyjfcSVOZXWxaWddbFw][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | 2026-01-06 02:16:37,754 [32m[FacilitatorEventRedisConsumer-handler-mMBsiUQgTlOtUmhamcl8tw][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while getting new messages [33m[0;39m 
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,118 [32m[TriggerExecutionEventStreamConsumer-handler-yW_rmkseTl2lzrVuVKLZgA][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:18,736 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "cvBumpIdx", "background": true} {"cvConfigId": 1, "clusterLevel": 1, "logCollectionMinute": 1, "host": 1, "createdAt": -1} [33m[indexName=cvBumpIdx, collectionName=logDataRecords][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:18,775 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "stateHostIdx", "background": true} {"stateExecutionId": 1, "logCollectionMinute": 1} [33m[indexName=stateHostIdx, collectionName=logDataRecords][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:19,124 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "stateBumpIndex", "background": true} {"stateExecutionId": 1, "clusterLevel": 1, "logCollectionMinute": 1, "host": 1} [33m[indexName=stateBumpIndex, collectionName=logDataRecords][0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,119 [32m[ProgressEventRedisConsumer-handler-R_amzOuyRdWwSO0gRxR7uA][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,124 [32m[InterruptEventRedisConsumer-handler-2NiWo24RQBK21stqyewYBA][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,118 [32m[SdkResponseEventRedisConsumer-handler-mQvRzo9tRgqtqCOTg7Djtg][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,121 [32m[WebhookEventStreamConsumer-handler-BVavosXIRHyjSjTKCKBI-A][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:36,551 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - No class store collection delegateConnectionResults with not final class software.wings.delegatetasks.validation.core.DelegateConnectionResult [33m[collectionName=delegateConnectionResults][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:36,611 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "delegateConnectionResultsMatchingCriteriaIdx", "background": true} {"accountId": 1, "criteria": 1} [33m[indexName=delegateConnectionResultsMatchingCriteriaIdx, collectionName=delegateConnectionResults][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:36,707 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "validUntil_1", "background": true, "expireAfterSeconds": 0} {"validUntil": 1} [33m[indexName=validUntil_1, collectionName=delegateConnectionResults][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:36,739 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "delegateId_1", "background": true} {"delegateId": 1} [33m[indexName=delegateId_1, collectionName=delegateConnectionResults][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:36,762 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "delegateConnectionResultsIdx", "unique": true} {"accountId": 1, "delegateId": 1, "criteria": 1} [33m[indexName=delegateConnectionResultsIdx, collectionName=delegateConnectionResults][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:36,788 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "criteria_1", "background": true} {"criteria": 1} [33m[indexName=criteria_1, collectionName=delegateConnectionResults][0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,119 [32m[NodeAdviseEventRedisConsumer-handler-Tvbm8tRrSc6Og-IG_bwNQg][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,161 [32m[InitiateNodeEventRedisConsumer-handler-naLy9sa_R-ih7qPqgiq0fQ][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | org.redisson.client.RedisResponseTimeoutException: Redis server response timeout (3000 ms) occured after 3 retry attempts. Increase nettyThreads and/or timeout settings. Try to define pingConnectionInterval setting. Command: (XPENDING), params: [streams:pipeline_initiate_node, PipelineService, -, +, 10], channel: [id: 0x929bdcbc, L:/192.168.0.2:35486 - R:redis/192.168.0.9:6379]
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,129 [32m[OrchestrationEventRedisConsumer-handler-N5woDTkxSqOrcrey9-WdgA][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,184 [32m[entity_crud][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,184 [32m[git_config_streamGitSyncSdk][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,185 [32m[PmsNotifyEventConsumerRedis-handler--y_c_0RIQUSUJpstHr3DDw][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,234 [32m[PipelineExecutionSummaryRedisEventConsumer-handler-DIIHvMmkQRqbCbKT258e8g][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | org.redisson.client.RedisTimeoutException: Command still hasn't been written into connection! Increase nettyThreads and/or retryInterval settings. Payload size in bytes: 0. Node source: NodeSource [slot=0, addr=null, redisClient=null, redirect=null, entry=null], connection: RedisConnection@2034273287 [redisClient=[addr=redis://redis:6379], channel=[id: 0x01b8e5b9, L:/192.168.0.2:35492 - R:redis/192.168.0.9:6379], currentCommand=null], command: (XPENDING), params: [streams:DEBEZIUM_pmsMongo.pms-harness.planExecutionsSummary, PipelineService, -, +, 100] after 3 retry attempts
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,191 [32m[redisson-netty-2-1][0;39m [31mWARN [0;39m [36mio.netty.channel.AbstractChannel[0;39m - Failed to mark a promise as failure because it's done already: DefaultChannelPromise@5d818f2f(failure: io.netty.util.concurrent.DefaultPromise$StacklessCancellationException) [33m[0;39m 
basic-harness-pipeline-service-1  | io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,275 [32m[redisson-netty-2-1][0;39m [31mWARN [0;39m [36mio.netty.channel.AbstractChannel[0;39m - Failed to mark a promise as failure because it's done already: DefaultChannelPromise@42c76cea(failure: io.netty.util.concurrent.DefaultPromise$StacklessCancellationException) [33m[0;39m 
basic-harness-pipeline-service-1  | io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,426 [32m[redisson-netty-2-1][0;39m [31mWARN [0;39m [36mio.netty.channel.AbstractChannel[0;39m - Failed to mark a promise as failure because it's done already: DefaultChannelPromise@46cb3a4e(failure: io.netty.util.concurrent.DefaultPromise$StacklessCancellationException) [33m[0;39m 
basic-harness-pipeline-service-1  | io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,785 [32m[redisson-netty-2-1][0;39m [31mWARN [0;39m [36mio.netty.channel.AbstractChannel[0;39m - Failed to mark a promise as failure because it's done already: DefaultChannelPromise@5b5b3a11(failure: io.netty.util.concurrent.DefaultPromise$StacklessCancellationException) [33m[0;39m 
basic-harness-pipeline-service-1  | io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,790 [32m[redisson-netty-2-1][0;39m [31mWARN [0;39m [36mio.netty.channel.AbstractChannel[0;39m - Failed to mark a promise as failure because it's done already: DefaultChannelPromise@4202d7c3(failure: io.netty.util.concurrent.DefaultPromise$StacklessCancellationException) [33m[0;39m 
basic-harness-pipeline-service-1  | io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,977 [32m[redisson-netty-2-1][0;39m [31mWARN [0;39m [36mio.netty.channel.AbstractChannel[0;39m - Failed to mark a promise as failure because it's done already: DefaultChannelPromise@77aa6419(failure: io.netty.util.concurrent.DefaultPromise$StacklessCancellationException) [33m[0;39m 
basic-harness-pipeline-service-1  | io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,987 [32m[redisson-netty-2-1][0;39m [31mWARN [0;39m [36mio.netty.channel.AbstractChannel[0;39m - Failed to mark a promise as failure because it's done already: DefaultChannelPromise@5ac450f5(failure: io.netty.util.concurrent.DefaultPromise$StacklessCancellationException) [33m[0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:47,864 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "publicDns_1", "background": true} {"publicDns": 1} [33m[indexName=publicDns_1, collectionName=serviceInstance][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:47,899 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "hostId_1", "background": true} {"hostId": 1} [33m[indexName=hostId_1, collectionName=serviceInstance][0;39m 
basic-harness-pipeline-service-1  | io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:38,990 [32m[redisson-netty-2-1][0;39m [31mWARN [0;39m [36mio.netty.channel.AbstractChannel[0;39m - Failed to mark a promise as failure because it's done already: DefaultChannelPromise@113ee397(failure: io.netty.util.concurrent.DefaultPromise$StacklessCancellationException) [33m[0;39m 
basic-harness-pipeline-service-1  | io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:39,289 [32m[NodeResumeEventRedisConsumer-handler-Xj8SWuDdR5epCC8i0h9DpQ][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | org.redisson.client.RedisTimeoutException: Command still hasn't been written into connection! Increase nettyThreads and/or retryInterval settings. Payload size in bytes: 0. Node source: NodeSource [slot=0, addr=null, redisClient=null, redirect=null, entry=null], connection: RedisConnection@1927299992 [redisClient=[addr=redis://redis:6379], channel=[id: 0x36a6761a, L:/192.168.0.2:35494 - R:redis/192.168.0.9:6379], currentCommand=null], command: (XPENDING), params: [streams:pipeline_node_resume, pms, -, +, 20] after 3 retry attempts
basic-harness-pipeline-service-1  | 2026-01-06 02:16:39,301 [32m[redisson-netty-2-1][0;39m [31mWARN [0;39m [36mio.netty.channel.AbstractChannel[0;39m - Failed to mark a promise as failure because it's done already: DefaultChannelPromise@6d72a1e(failure: io.netty.util.concurrent.DefaultPromise$StacklessCancellationException) [33m[0;39m 
basic-harness-pipeline-service-1  | io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | 2026-01-06 02:16:49,804 [32m[PipelineExecutionSummaryRedisEventConsumer-handler-DIIHvMmkQRqbCbKT258e8g][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-manager-1           | 2026-01-06 02:08:49,842 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - No class store collection hosts with not final class software.wings.beans.infrastructure.Host [33m[collectionName=hosts][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:49,888 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "app_inframappingid", "background": true} {"appId": 1, "infraMappingId": 1} [33m[indexName=app_inframappingid, collectionName=hosts][0;39m 
basic-harness-pipeline-service-1  | 2026-01-06 02:19:14,773 [32m[PipelineExecutionSummaryRedisEventConsumer-handler-DIIHvMmkQRqbCbKT258e8g][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:49,970 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "serviceTemplateId_1", "background": true} {"serviceTemplateId": 1} [33m[indexName=serviceTemplateId_1, collectionName=hosts][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:49,998 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "hostName_1", "background": true} {"hostName": 1} [33m[indexName=hostName_1, collectionName=hosts][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:50,042 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "createdAt_1", "background": true} {"createdAt": 1} [33m[indexName=createdAt_1, collectionName=hosts][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:50,071 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "appId_envId_inframappingId_hostName", "background": true} {"appId": 1, "envId": 1, "infraMappingId": 1, "hostName": 1} [33m[indexName=appId_envId_inframappingId_hostName, collectionName=hosts][0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-pipeline-service-1  | io.harness.exception.InvalidRequestException: Error occurred while performing this operation.
basic-harness-pipeline-service-1  | 2026-01-06 02:24:17,730 [32m[ProgressEventRedisConsumer-handler-R_amzOuyRdWwSO0gRxR7uA][0;39m [31mWARN [0;39m [36mio.harness.eventsframework.impl.redis.RedisAbstractConsumer[0;39m - Exception occurred while listing pending entries [33m[0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:53,530 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - No class store collection delegateConnections with not final class software.wings.beans.DelegateConnection [33m[collectionName=delegateConnections][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:53,551 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "lastHeartbeatIndex", "background": true} {"disconnected": 1, "lastHeartbeat": 1} [33m[indexName=lastHeartbeatIndex, collectionName=delegateConnections][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:53,611 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "validUntil_1", "background": true, "expireAfterSeconds": 0} {"validUntil": 1} [33m[indexName=validUntil_1, collectionName=delegateConnections][0;39m 
basic-harness-manager-1           | 2026-01-06 02:08:53,643 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "index2", "background": true} {"accountId": 1, "delegateId": 1, "version": 1} [33m[indexName=index2, collectionName=delegateConnections][0;39m 
basic-harness-pipeline-service-1  | Caused by: io.netty.channel.StacklessClosedChannelException: null
basic-harness-manager-1           | 2026-01-06 02:08:56,493 [32m[main][0;39m [31mWARN [0;39m [36mio.harness.mongo.IndexManagerSession[0;39m - Creating index {"name": "uniqueDelegateSequenceIdx", "unique": true} {"accountId": 1, "hostName": 1, "sequenceNum": 1} [33m[indexName=uniqueDelegateSequenceIdx, collectionName=delegateSequenceConfig][0;39m 
