...
### Pluralsight
  ...
  * [Architecting Schemaless Scalable NoSQL Databases Using Google Datastore](https://app.pluralsight.com/library/courses/google-cloud-platform-datastore-nosql-architecting-schemaless-scalable-databases)
  ...
  * [API Developer Learning Path](https://app.pluralsight.com/paths/skill/developing-apis-with-google-clouds-apigee-api-platform)
...
#### Google Cloud Documentation
  ...
  * https://cloud.google.com/compute/docs/instance+groups#managed_instance_groups
    ...
    + https://cloud.google.com/compute/docs/instance+groups/create+zonal+mig#terraform
  * https://cloud.google.com/compute/docs/autoscaler
  * https://cloud.google.com/compute/docs/networking/network+overview
  * https://cloud.google.com/load-balancing/docs/choosing-load-balancer
    + HTTP or HTTPS: Application Load Balancer
    + TCP with optional SSL offload: proxy Network Load Balancer -  terminate incoming client connections at the load balancer and then open new connections from the load balancer to the backends.
    + TCP or UDP, ICMP: passthrough Network Load Balancer
  ...
  * https://cloud.google.com/firewall/docs/firewalls
    + https://cloud.google.com/firewall/docs/using+firewalls#gcloud_6
  ...
  * https://www.geeksforgeeks.org/google+cloud+platform+understanding+functions+as+a+service+faas
     + Cloud Functions
     + Cloud Run
  * https://cloud.google.com/kubernetes+engine/docs/concepts/kubernetes+engine+overview
  * benefits:
     + platform managements: autoscaling, node repair, autopilot
     + availability
     + security
  ...
  * https://cloud.google.com/eventarc/docs/overview#eventarc+triggers
