...
```  
  ...
  * [Guide](https://www.baeldung.com/spring-boot-testing-configurationproperties) to testing Spring Boot `@ConfigurationProperties`
  ...
  * https://lp.scylladb.com/sql-to-nosql-architecture-wp-offer.html
  * https://cloudacademy.com/blog/microservices-architecture-challenge-advantage-drawback/
  * https://www.shopify.com/enterprise/blog/disadvantages-microservices
    + complexity
    + debugging
    + cost
    ...
    + microservices are slower to implement for small companies
    
  * https://pretius.com/blog/java-17-features/  
    + Java 9 Modules Jigsaw https://openjdk.org/projects/jigsaw/
    + Java 17 aggregativ
     - `var` keyword (java10 except for functional, and java 11 also in lambda)
     - `record` keyword 
     - `switch` improvements
     - `instanceof`
     - `"""` blocks
  ...
  * https://www.baeldung.com/java-cucumber-pass-list-param-testing
