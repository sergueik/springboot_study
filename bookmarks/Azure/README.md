### Links to Azure Trainings and Documentation
  ...
  * [Securing Applications and APIs with the Microsoft Identity Platform](https://www.pluralsight.com/paths/securing-applications-and-apis-with-the-microsoft-identity-platform) (path)
    ...
    + [Developing Daemons and Services Protected by Azure Active Directory](https://app.pluralsight.com/library/courses/developing-daemons-services-protected-azure-active-directory)
	  ...
	  + [Developing Azure Active Directory B2C Applications](https://app.pluralsight.com/library/courses/developing-azure-active-directory-b2c-applications)
  ...
  * [GitHub Actions Deep Dive - A Cloud Guru](https://www.pluralsight.com/cloud-guru/courses/github-actions-deep-dive)
  ...
  * [getting started with ARM template](https://achraf-chennan.medium.com/getting-started-with-arm-templates-85ce1e6499e0)
  ...
  * __Microsoft practice assessment Takeaways__
    ...
    + [what is Azure Blob Storage Lifecycle Management](https://tech-tutes.com/2021/05/06/azure-storage-what-is-lifecycle-management-and-implementation)
...
﻿   + https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing
    + https://learn.microsoft.com/en-us/training/modules/configure-continuous-deployment-container-apps
    ...
    + https://learn.microsoft.com/en-us/azure/aks/tutorial-kubernetes-app-update?tabs=azure-cli
    + https://docs.microsoft.com/bs-latn-ba/azure/hdinsight/hadoop +

    + https://learn.microsoft.com/en-us/azure/architecture/best-practices/transient-faults
    + https://learn.microsoft.com/en-us/system-center/scom/manage-operations-guide-overview?view=sc-om-2022
    ...
    + https://azure.microsoft.com/en-us/blog/data-management-gateway-high-availability-and-scalability-preview
    ...
    + https://docs.microsoft.com/en-us/azure/virtual-machines/windows/manage-availability (why is it AZ-204?)
    + https://docs.microsoft.com/en-us/azure/virtual-machines/availability-set-overview (why is it AZ-204?)
    + https://docs.microsoft.com/en-us/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-manage-fault-domains (why is it AZ-204?)
    ...
    + https://learn.microsoft.com/en-us/archive/blogs/make_it_better/simple-websites-using-azure-storage-blob-service
    + https://learn.microsoft.com/en-us/azure/kusto/query
    + https://learn.microsoft.com/en-us/azure/azure-monitor/essentials/metrics-getting-started#create-your-first-metric-chart
    + https://learn.microsoft.com/en-us/azure/azure-monitor/essentials/metrics-getting-started
    + https://learn.microsoft.com/en-us/azure/azure-monitor/app/api-custom-events-metrics#getmetric
    ...
    + [](https://www.youtube.com/watch?v=FRlWiAzjHC8)	
    + https://learn.microsoft.com/cli/azure/container?view=azure-cli-latest#az-container-restart 
    + https://learn.microsoft.com/azure/container-instances/container-instances-multi-container-group
    ...
    + https://learn.microsoft.com/en-us/azure/cdn/cdn-app-dev-node
    + https://learn.microsoft.com/azure/azure-monitor/app/get-metric
    ...
    + https://learn.microsoft.com/en-us/Azure/app-service/troubleshoot-diagnostic-logs = (git , deployment, application, web w3c traces, web server logs, detailed errors)
    ...
    + https://learn.microsoft.com/en-in/azure/storage/queues/storage-quickstart-queues-dotnet
    + https://learn.microsoft.com/en-us/rest/api/load-balancer/load-balancers/create-or-update
    + https://learn.microsoft.com/azure/container-apps/
    + https://learn.microsoft.com/azure/app-service/deploy-configure-credentials?tabs=cli
    ...
    + https://learn.microsoft.com/cli/azure/webapp/config/access-restriction
    + https://developer.microsoft.com/graph/graph-explorer
    + https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/azure-subscription-service-limits
    + https://learn.microsoft.com/en-us/azure/cdn/cdn-features
    + [Azure Functions C# script (.csx) developer reference](https://learn.microsoft.com/en-us/azure/azure-functions/functions-reference-csharp?tabs=functionsv)
    ...
    + https://learn.microsoft.com/azure/active-directory/managed-identities-azure-resources/qs-configure-portal-windows-vm
    + https://learn.microsoft.com/azure/advisor
    + https://learn.microsoft.com/en-us/azure/azure-cache-for-redis
    + https://azure.microsoft.com/en-us/updates/immutableappendblob
    + https://redis.io/docs/manual/pubsub
    + https://redis.io/topics/streams-intro
    + https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-overview
    + https://learn.microsoft.com/azure/api-management/api-management-subscriptions
    + https://learn.microsoft.com/azure/api-management/api-management-transformation-policies
    + https://learn.microsoft.com/azure/api-management/set-edit-policies?tabs=form
    ...
    + https://learn.microsoft.com/en-us/azure/storage/blobs/storage-blob-container-properties-metadata
    + https://github.com/uglide/azure-content/blob/master/articles/azure-functions/functions-bindings-http-webhook.md
    ...
    + https://learn.microsoft.com/en-us/azure/azure-monitor/essentials/metrics-getting-started
    + https://learn.microsoft.com/en-us/azure/azure-monitor/app/codeless-overview#supported-environments-languages
    ...
    + https://learn.microsoft.com/en-us/azure/azure-monitor/app/availability-azure-functions
    + https://learn.microsoft.com/en-us/dotnet/api/microsoft.applicationinsights.telemetryclient.trackavailability
    + https://learn.microsoft.com/en-us/azure/azure-monitor/app/troubleshoot-availability
    ...
    + https://learn.microsoft.com/azure/azure-app-configuration/concept-key-value
    ...
    + https://learn.microsoft.com/azure/azure-functions/functions-bindings-http-webhook
    ...
    + https://learn.microsoft.com/en-us/azure/azure-functions/functions-premium-plan#region-max-scale-out
    ...
    + https://learn.microsoft.com/azure/azure-monitor/app/availability-multistep
    + https://learn.microsoft.com/azure/azure-monitor/app/create-new-resource
    ...
    + https://learn.microsoft.com/azure/container-instances/container-instances-restart-policy
    ...
    + https://learn.microsoft.com/azure/cosmos-db/nosql/query/parameterized-queries
    + https://learn.microsoft.com/azure/cosmos-db/nosql/read-change-feed
    + https://learn.microsoft.com/azure/event-grid/concepts
    + https://learn.microsoft.com/azure/event-grid/custom-event-quickstart
    + https://learn.microsoft.com/azure/event-hubs/event-hubs-capture-enable-through-portal
    + https://learn.microsoft.com/azure/key-vault/certificates/certificate-scenarios
    + https://learn.microsoft.com/azure/service-bus-messaging/service-bus-azure-and-service-bus-queues-compared-contrasted
    + https://learn.microsoft.com/azure/service-bus-messaging/service-bus-messages-payloads
    ...
    + https://learn.microsoft.com/cli/azure/acr/repository?view=azure-cli-latest#az-acr-repository-delete
    + https://learn.microsoft.com/cli/azure/container?view=azure-cli-latest#az-container-create
    + https://learn.microsoft.com/cli/azure/container?view=azure-cli-latest#az-container-restart
    + https://learn.microsoft.com/cli/azure/container?view=azure-cli-latest
    + https://learn.microsoft.com/cli/azure/keyvault/secret
    + https://learn.microsoft.com/dotnet/api/azure.storage.blobs.specialized.blobbaseclient.downloadcontent
    + https://learn.microsoft.com/dotnet/api/overview/azure/redis-cache
    + https://learn.microsoft.com/en-us/azure/storage/common/storage-sas-overview
    + https://learn.microsoft.com/graph/paging
    + https://learn.microsoft.com/javascript/api/@azure/event-hubs/eventhubproducerclient?view=azure-node-latest
    ...
    + https://learn.microsoft.com/rest/api/storageservices/create-user-delegation-sas
    + https://learn.microsoft.com/rest/api/storageservices/define-stored-access-policy
    + https://learn.microsoft.com/rest/api/storageservices/setting-and-retrieving-properties-and-metadata-for-blob-resources
    + https://azure.microsoft.com/blog/announcing-http-2-support-in-azure-app-service
...
* Git
  ...
  + [Managing Source Code with Git](https://app.pluralsight.com/paths/skill/managing-source-code-with-git)(path)
  + [Git Branching and Merging](https://app.pluralsight.com/library/courses/git-branching-merging)
  + [Git Hooks](https://app.pluralsight.com/library/courses/git-hooks)

*  Misc
   + [Lab - Working Smarter with PowerShell Background Jobs](https://app.pluralsight.com/labs/detail/9c72a7bc-69b0-42df-b88a-e36f87319100/toc)
   + [Getting Started with Windows Subsystem for Linux](https://app.pluralsight.com/library/courses/windows-subsystem-linux-getting-started/table-of-contents)
   + [Test Automation](https://app.pluralsight.com/paths/skill/test-automation)(path)
   + [Hibernate Fundamentals](https://app.pluralsight.com/library/courses/hibernate-fundamentals/table-of-contents)
 ...
 * GitHub Actions
  ...
  * https://learn.microsoft.com/en-us/training/modules/github-actions-automate-tasks/5-summary
    ...
    + https://docs.github.com/actions/learn-github-actions/introduction-to-github-actions#the-components-of-github-actions
  ...
  * https://learn.microsoft.com/en-us/training/modules/github-actions-ci/5-summary
