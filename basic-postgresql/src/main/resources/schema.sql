...
CREATE TABLE IF NOT EXISTS rest ( id serial PRIMARY KEY NOT NULL, key varchar(100) NOT NULL, value varchar(250) NOT NULL, timestamp TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT clock_timestamp(), rand smallint NOT NULL );
-- MySQL
